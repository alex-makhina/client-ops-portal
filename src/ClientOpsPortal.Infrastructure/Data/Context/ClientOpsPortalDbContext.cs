    ...
    public class ClientOpsPortalDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SubscriptionHistory>(entity =>
            {
                ...
                entity.HasOne(sh => sh.TariffPlan)
                    .WithMany()
                    .HasForeignKey(sh => sh.TariffPlanId)
                    .OnDelete(DeleteBehavior.Restrict);

                entity.HasMany(sh => sh.Steps)
                    .WithOne()
                    .HasForeignKey(shs => shs.SubscriptionHistoryId)
                    .OnDelete(DeleteBehavior.Restrict);
            });
